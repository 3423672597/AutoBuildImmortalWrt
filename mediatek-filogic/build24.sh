...
PACKAGES="luci-i18n-frps-zh-cn"
PACKAGES="luci-i18n-openvpn-zh-cn"
PACKAGES="luci-i18n-openvpn-server-zh-cn"
PACKAGES=" luci-i18n-softethervpn-zh-cn"

PACKAGES="wpad-wolfssl"
PACKAGES="usteer"
# 文件管理器
